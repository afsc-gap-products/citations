...
Find a print out of all of the citations currently included in this repo's [`bibliography.bib`](`r paste0(link_repo, "/cite/bibliography.bib")`) in this [document](`r paste0(link_repo, "/blob/main/testing/print_bib.pdf")`)  
